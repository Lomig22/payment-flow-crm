-- ============================================================
-- Sprint 12 — Timeline Cold Call enrichie (Activité 30 derniers jours)
--   Ajoute par jour : appelés, relances, relances 2, RDV, perdus
--   (en plus de leads créés & clients). Même sémantique « état actuel »
--   (dernière transition via lead_history) que le reste du dashboard.
