...
function Column({ status, leads, label, colorClass }: {
  status: LeadStatus; leads: Lead[]; label: string; colorClass: string;
}) {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`card flex flex-col min-h-96 border-t-4 ${colorClass}`}
      style={{ minWidth: 260 }}
    >
      ...
      <div className="flex-1 p-2 space-y-2 overflow-y-auto max-h-[70vh] scrollbar-thin">
...
export default function PipelinePage() {
  ...
  const getColumn = (status: LeadStatus) =>
