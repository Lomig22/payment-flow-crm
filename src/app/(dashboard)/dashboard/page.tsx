  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total leads"       value={overview.total_leads}          icon={Users}      color="purple" />
        <StatCard title="Leads appelés"     value={overview.leads_called}         icon={PhoneCall}  color="blue"   />
        <StatCard title="RDV pris"          value={overview.appointments_taken}   icon={CalendarCheck} color="orange" />
        <StatCard title="Clients signés"    value={overview.clients_signed}       icon={UserCheck}  color="green"  />
        <StatCard title="Taux de conversion" value={overview.conversion_rate}     icon={TrendingUp} suffix="%" color="green" />
        <StatCard title="Taux de no-show"   value={overview.no_show_rate}         icon={XCircle}    suffix="%" color="red"   />
        <StatCard title="Devis envoyés"     value={overview.quotes_sent}          icon={BarChart3}  color="blue"   />
        <StatCard title="RDV honorés"       value={overview.appointments_honored} icon={Award}      color="purple" />
      </div>
